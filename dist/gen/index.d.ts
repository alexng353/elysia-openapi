 ...
 */
export declare function extractEnums(source: string): Record<string, string>;
/**
 ...
 */
export declare function extractConstArrays(source: string): Record<string, string>;
/**
 * Replace `(typeof X)[number]` patterns with the resolved union type
 * from const array declarations.
 */
export declare function resolveTypeofIndexed(code: string, constArrays: Record<string, string>): string;
/**
...
export declare function declarationToJSONSchema(declaration: string, typeAliases?: Record<string, string>, constArrays?: Record<string, string>): AdditionalReference;
/**
