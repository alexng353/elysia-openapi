 ...
 */
export declare function toOpenAPISchema(app: AnyElysia, exclude?: ElysiaOpenAPIConfig['exclude'], references?: AdditionalReferences, vendors?: MapJsonSchema, onlyExternal?: boolean): {
    components: {
        schemas: any;
    };
